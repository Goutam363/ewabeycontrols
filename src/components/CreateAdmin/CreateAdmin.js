...
export default function CreateAdmin() {
  ...
  const validate = async () => {
    ...
    try {
      const res = await axios.get(
        `${process.env.REACT_APP_EWABEY_BACKEND_URL}/auth/check/${username}/admin`
      );
      if (res.data.exist) {
  ...
  const handleCreateAdmin = async () => {
    ...
    if (res && loggedin && amAdmin) {
      try {
        await axios.post(
          `${process.env.REACT_APP_EWABEY_BACKEND_URL}/auth/secure/admin/signup/by-adm`,
          {
            name,
            email: emailId,
            username,
        ...
        await axios.post(
          `${process.env.REACT_APP_EWABEY_BACKEND_URL}/mail/notification/create-admin`,
          {
            username,
            password,
          },
